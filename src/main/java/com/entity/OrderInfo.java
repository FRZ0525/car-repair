...
public class OrderInfo {
	...
	public String getTrouble_price() {
		return trouble_price;
	}
	public void setTrouble_price(String trouble_price) {
		this.trouble_price = trouble_price;
	}
	...
	public String toString() {
		return "OrderInfo [id=" + id + ", user_id=" + user_id + ", user_name=" + user_name + ", plate=" + plate
				+ ", trouble_code=" + trouble_code + ", trouble_name=" + trouble_name + ", contact=" + contact
				+ ", contact_way=" + contact_way + ", remark=" + remark + ", creart_time=" + creart_time
				+ ", long_time=" + long_time + ", status=" + status + ", trouble_price=" + trouble_price
